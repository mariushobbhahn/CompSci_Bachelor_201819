...
def build_run_parameter_grid(datasets, formats, random_augs, batch_norm):
    runs = []
    for d in datasets:
        for f in formats:
...
if __name__ == "__main__":
    ...
    runs = build_run_parameter_grid(datasets=datasets, formats=formats, random_augs=random_augs, batch_norm = batch_norms)
