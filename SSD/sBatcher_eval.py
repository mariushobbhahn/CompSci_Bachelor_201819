...
if __name__ == "__main__":
    ...
    parser.add_argument('--gen', default='12.5', type=str, help="generation of the currents test series")
    ...
    gen = '13'
    runs = build_run_parameter_grid(datasets=datasets, formats=formats, random_augs=random_augs, batch_norm=batch_norms, gen=gen)
