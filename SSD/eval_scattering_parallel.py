...
parser.add_argument('--trained_model',
                    default='weights/scattering_parallel_ssd_J2_toy_data_no_pretrained_random_12.8_125000.pth', type=str, help='Trained state_dict file path to open')
...
def test_net(save_folder, cuda, dataset, transform, top_k, inp_channels,
             im_size=300, thresh=0.0):

    net = build_scattering_parallel_ssd(phase='test', inp_channels=inp_channels, size_x=cfg['dim_x'], size_y=cfg['dim_y'], num_classes=cfg['num_classes'], cfg=cfg, pretrained=args.pretrained_weights)
    ...
    if args.dataset == "VOC":
        ...
        output_dir = get_output_dir('ssd300_120000_toy_data', set_type)
    ...
    for i in range(num_images):
        ...
        detections = net(x, scatterings, Ks).data
...
if __name__ == '__main__':
    ...
    # evaluation
    test_net(save_folder=args.save_folder, cuda=args.cuda, dataset=dataset, inp_channels=3,
